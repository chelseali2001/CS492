...
class ForecastDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_FORECAST_PERIOD)) {
            ...
            val unit = sharedPrefs.getString(getString(R.string.pref_units_key), null)
            ...
            if (unit == "imperial") {
                ...
                findViewById<TextView>(R.id.tv_low_temp).text =
                    getString(R.string.forecast_temp, forecastPeriod!!.lowTemp, "C")

                findViewById<TextView>(R.id.tv_high_temp).text =
                    getString(R.string.forecast_temp, forecastPeriod!!.highTemp, "C")
            } else if (unit == "kelvin") {
                findViewById<TextView>(R.id.tv_low_temp).text =
                    getString(R.string.forecast_temp, forecastPeriod!!.lowTemp, "K")

                findViewById<TextView>(R.id.tv_high_temp).text =
                    getString(R.string.forecast_temp, forecastPeriod!!.highTemp, "K")
            }
