...
class ForecastAdapter(private val onClick: (ForecastPeriod) -> Unit)
    ...
    class ViewHolder(itemView: View, val onClick: (ForecastPeriod) -> Unit)
        ...
        fun bind(forecastPeriod: ForecastPeriod, forecastCity: ForecastCity?) {
            ...
            val unit = sharedPrefs.getString(ctx.getString(R.string.pref_units_key), null)
            ...
            if (unit == "imperial") {
                ...
                highTempTV.text = ctx.getString(R.string.forecast_temp, forecastPeriod.highTemp, "C")
                lowTempTV.text = ctx.getString(R.string.forecast_temp, forecastPeriod.lowTemp, "C")
            } else if (unit == "kelvin") {
                highTempTV.text = ctx.getString(R.string.forecast_temp, forecastPeriod.highTemp, "K")
                lowTempTV.text = ctx.getString(R.string.forecast_temp, forecastPeriod.lowTemp, "K")
            }
