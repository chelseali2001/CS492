 ...
 */
const val OPENWEATHER_APPID = "6ea62b7d1ad89ea0dd964e49ffb0b7b7"
...
class MainActivity : AppCompatActivity() {
    ...
    var oldLocation : String? = "Corvallis"
    var oldUnit : String? = "imperial"
...
*/
        ...
        viewModel.loadSearchResults(location, units)

        //fetchFiveDayForecast("Corvallis,OR,US", "metric")
    }
    ...
    override fun onResume() {
        ...
        if (location != oldLocation || units != oldUnit) {
            viewModel.loadSearchResults(location, units)
        }
    }
    ...
    override fun onPause() {
        ...
        oldLocation = sharedPrefs.getString(
            getString(R.string.pref_location_key),
            null
        )

        oldUnit = sharedPrefs.getString(
            getString(R.string.pref_units_key),
            null
        )
    }
